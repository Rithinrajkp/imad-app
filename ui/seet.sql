...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2017 at 10:52 PM
...
(32, 14, 'What is your name?', 'a', 'b', 'c', 'd', 1);
...
(12, 2, 'Computer Fundamentals', '5'),
(13, 3, 'English Grammar', '5'),
(14, 1, 'Aptitude type', '5');
...
INSERT INTO `mst_user` (`user_id`, `username`, `email`, `ano`, `pass`) VALUES
(18, 'raj', 'raj@gmail.com', '123456789123', '123456'),
(35, 'tom', 'tom@gmail.com', '789456123123', '123'),
(36, 'a', 'a@gmail.com', '789456123456', '123'),
(37, 'b', 'b@gmail.com', '147852369789', '123');
...
('idjir9pcq2d07764us8rdiq9n5', 11, 'how to use date( ) in mysql ?', 'now( )', 'today( )', 'date( )', 'time( )', 0, 1),
('idjir9pcq2d07764us8rdiq9n5', 11, 'how to use date( ) in mysql ?', 'now( )', 'today( )', 'date( )', 'time( )', 0, 1),
('0po6ak86ijaorhhnim8v1moc91', 14, 'What is your name?', 'a', 'b', 'c', 'd', 1, 1);
